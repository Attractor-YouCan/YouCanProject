...
public class TestInitializer
{
    ...
    public void Seed()
    {
        ...
        _modelBuilder.Entity<Answer>().HasData(
            ...
            new Answer(){Id = 69, QuestionId = 18, IsCorrect = false, Text = "Грамматика это чудо"},
            new Answer(){Id = 70, QuestionId = 18, IsCorrect = false, Text = "Грамматика это таска"},
            new Answer(){Id = 71, QuestionId = 18, IsCorrect = false, Text = "Грамматика это пипец"},
            new Answer(){Id = 72, QuestionId = 18, IsCorrect = true, Text = "Грамматика это 5 по русскому"},
            new Answer(){Id = 73, QuestionId = 19, IsCorrect = false, Text = "A больше"},
            new Answer(){Id = 74, QuestionId = 19, IsCorrect = true, Text = "B больше"},
            new Answer(){Id = 75, QuestionId = 19, IsCorrect = false, Text = " оба равны"},
            new Answer(){Id = 76, QuestionId = 19, IsCorrect = false, Text = "нельзя сравнить"},
            ...
            new Answer(){Id = 61, QuestionId = 20, IsCorrect = false, Text = "A больше"},
            new Answer(){Id = 62, QuestionId = 20, IsCorrect = true, Text = "B больше"},
            new Answer(){Id = 63, QuestionId = 20, IsCorrect = false, Text = " оба равны"},
            new Answer(){Id = 64, QuestionId = 20, IsCorrect = false, Text = "нельзя сравнить"},
            new Answer(){Id = 65, QuestionId = 21, IsCorrect = false, Text = "Площадь под функции f(x)"},
            new Answer(){Id = 66, QuestionId = 21, IsCorrect = false, Text = "интеграл от f(x) от 0 до x"},
            new Answer(){Id = 67, QuestionId = 21, IsCorrect = true, Text = "Функция, производная которой равна f(x)"},
            new Answer(){Id = 68, QuestionId = 21, IsCorrect = false, Text = "Функция, производная которой равна Y(f-k)"}
        );
    }
}