...
public class TrainTestInitializer
{
    ...
    public void Seed()
    {
        ...
        _modelBuilder.Entity<Question>().HasData(
            new Question(){Id = 7, TestId = 3, Instruction = "Выберите правильный вариант", Text = "В каком слове вместо точек следует вставить букву с?"},
            new Question(){Id = 8, TestId = 3, Instruction = "Выберите правильный вариант", Text = "В каком предложении подчеркнутое слово можно заменить словом (высохший (-ая, -ее))?"},
            new Question(){Id = 9, TestId = 3, Instruction = "Выберите правильный вариант", Text = "В каком слове вместо точек следует вставить букву з?"},
            new Question(){Id = 10, TestId = 3, Instruction = "Выберите правильный вариант", Text = "В каком предложении подчеркнутое слово употреблено в правильной форме?"},
            new Question(){Id = 11, TestId = 3, Instruction = "Какое слово следует вставить вместо точек в предложение?", Text = "Задание, ... нами, не вызывает особых затруднений."}
        );
