...
public class SubjectInitializer
{
    ...
    public void Seed()
    {
        _modelBuilder.Entity<Subject>().HasData(
            ...
            new Subject(){Id = 7, Name = "Reading and Understanding", ImageUrl = "/topicImages/readUnderstIcon.png", ParentId = 2, SubjectType = SubjectType.Child, UserTestType = Entities.UserTestType.Test},
