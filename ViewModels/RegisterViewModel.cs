...
public class RegisterViewModel
{
    ...
    [Remote(action: "CheckEmail", controller:"Validation", areaName: "", ErrorMessage = "Данный Email уже занят!")]
    ...
    [Remote(action: "CheckPhoneNumber", controller:"Validation", areaName: "", ErrorMessage = "Данный PhoneNumber уже занят!")]
    public string PhoneNumber { get; set; }

    [Required(ErrorMessage = "Заполните поле Username")]
    [Remote(action: "CheckUsername", controller: "Validation", areaName: "", ErrorMessage = "Данный UserName уже занят!")]
