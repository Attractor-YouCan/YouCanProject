...
public class RegisterViewModel
{
    ...
    [Remote(action: "CheckPhoneNumber", controller:"Validation", ErrorMessage = "Данный Номер телефона уже зарегистрирован!")]
    public string PhoneNumber { get; set; }
    [Required(ErrorMessage = "Заполните поле Никнейм")]
    [Remote(action: "CheckUsername", controller:"Validation", ErrorMessage = "Данный Никнейм уже занят!")]
